...
syn keyword scsAgentIdtfs abstract_sc_agent scp_program_sc_text platform_independent_abstract_sc_agent active_sc_agent
syn keyword scsQuestionConst question question_initiated question_finished
syn keyword scsAgentIdtfs nrel_primary_initiation_condition nrel_initiation_condition_and_result nrel_sc_agent_key_sc_elements nrel_sc_agent_program nrel_answer
syn keyword scEvent sc_event_add_output_arc

syn match scsEmpty "[\.]\{3\}"
syn match scsType "\<sc_\(node\|link\|edge_dcommon\|edge_ucommon\|edge_main\|edge_access\)\>"
...
syn keyword scpFunc nrel_goto nrel_then nrel_else
...
hi def link scsAgentIdtfs       Keyword
hi def link scsEmpty            Identifier
hi def link scsType             Define
hi def link scsVar              Special
hi def link scsQuestionConst    Constant
hi def link scEvent             Function
